...
$sql = "SELECT pa.id_pago, pa.id_contrato, cl.nombre_completo_cliente,pro.direccion, pa.monto_pago, pa.fecha_registro
    FROM pagos as pa
    JOIN contratos as c 
    ...
    <tbody>
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            <tr>
                ...
                <td>
                    <?php echo $fila['monto_pago'] ?>
                </td>
                <td>
                    <?php echo $fila['fecha_registro'] ?>
                </td>
                <td>
                    <?php echo "<a href='EditarPago.php?id_pago=" . $fila['id_pago'] . "'>Editar</a>"; ?>
                    -
                    <?php echo "<a href='EliminarPago.php?id_pago=" . $fila['id_pago'] . "'>Eliminar</a>"; ?>
                </td>
            </tr>
            <?php
